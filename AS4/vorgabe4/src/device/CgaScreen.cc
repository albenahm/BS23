...
unsigned int neuBildschirm    = bildschirmGroesse -80; // da eine Zeile aus 160 Bytes (80 Attr)(80 Char) besteht.
...
for(unsigned int i=neuBildschirm;i<neuBildschirm+COLUMNS;i++){
